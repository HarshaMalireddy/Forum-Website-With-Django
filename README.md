...
CS 326 Web Programming Group Project
...
- Used the model-view-template (MVT) architecture of Django to write methods in model, views, and forms python files and create several HTML5 template files to render the webpages
